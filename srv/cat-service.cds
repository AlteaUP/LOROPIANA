...
using { ZZ1_ZMFI_DATAPRELIEVO_CDS } from './EXTERNAL/ZZ1_ZMFI_DATAPRELIEVO_CDS';
...
service CatalogService {
    ...
    @readonly entity MainCds as projection on customCDS.ZZ1_I_COMBORDER_COMP{
        ...
        TotalRequiredQuantity : Decimal,
        TotalDeliveryQty : Decimal,
        TotalConfdQtyForATPInBaseUoM: Decimal,
        TotalWithdrawnQuantity : Decimal,
        TotalQuantityInEntryUnit : Decimal,
        TotalDefaultAllocQty : Decimal,
    ...
    @readonly entity ZZ1_ZMFI_DATAPRELIEVO as projection on ZZ1_ZMFI_DATAPRELIEVO_CDS.ZZ1_ZMFI_DATAPRELIEVO;

    @readonly entity ZZ1_ZMFG_C_OUTBOUNDDELIVER as projection on ZZ1_ZMFG_C_OUTBOUNDDELIVER_CDS.ZZ1_ZMFG_C_OUTBOUNDDELIVER;
