/* checksum : 38aa721a2d701bcbf20519fd2649c123 */
@cds.external : true
@m.IsDefaultEntityContainer : 'true'
@sap.message.scope.supported : 'true'
@sap.supported.formats : 'atom json xlsx'
service OP_API_MATERIAL_DOCUMENT_SRV {};
...
entity OP_API_MATERIAL_DOCUMENT_SRV.A_MaterialDocumentHeader {
  ...
  to_MaterialDocumentItem : Composition of many OP_API_MATERIAL_DOCUMENT_SRV.A_MaterialDocumentItem {  };
} actions {
  action Cancel(
    @odata.Type : 'Edm.DateTime'
    @sap.label : 'Posting Date'
    PostingDate : DateTime
  ) returns OP_API_MATERIAL_DOCUMENT_SRV.A_MaterialDocumentHeader;
};
...
entity OP_API_MATERIAL_DOCUMENT_SRV.A_MaterialDocumentItem {
  @sap.display.format : 'NonNegative'
  @sap.label : 'Material Document Year'
  key MaterialDocumentYear : String(4) not null;
  @sap.display.format : 'UpperCase'
  ...
  to_MaterialDocumentHeader : Association to OP_API_MATERIAL_DOCUMENT_SRV.A_MaterialDocumentHeader {  };
  to_SerialNumbers : Association to many OP_API_MATERIAL_DOCUMENT_SRV.A_SerialNumberMaterialDocument {  };
} actions {
  action CancelItem(
    @odata.Type : 'Edm.DateTime'
    @sap.label : 'Posting Date'
    PostingDate : DateTime
  ) returns OP_API_MATERIAL_DOCUMENT_SRV.A_MaterialDocumentItem;
};
...
entity OP_API_MATERIAL_DOCUMENT_SRV.A_SerialNumberMaterialDocument {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
